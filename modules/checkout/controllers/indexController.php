...
function indexAction()
{
    ...
    if (isset($_POST['btn_order'])) {
        ...
        if (empty($error)) {
            ...
            $subject = "[Phong Apple] Xác nhận đặt hàng";
            ...
            <div class='top-info'>
                ...
                <span class='sub-title'>Cảm ơn Anh/Chị đã tin tưởng lựa chọn Phong Apple</span>
            </div>
            <div class='content-info'>
                ...
                <ul>
                    ...
                    <li style='padding: 5px 0;'>
                        ...
                        <span>phongqn@gmail.com hoặc sđt:078.804.8699</span>
                    </li>
                </ul>
            </div>
            <div class'footer-info'>
                <p>Phong Apple hẹn gặp lại quý khách !</p>
            </div>
        </div>";
